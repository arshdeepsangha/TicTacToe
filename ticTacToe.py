...
def play_game():
    ...
    answer = int(input())
    print('What do you want to play as? X or O')
    try:
        playerType = raw_input().upper()
    ...
    if answer == 1:
        ...
        multiplayer_game(playerType)
    else: 
        play_game()

# TODO
# def singleplayer_game(playerType):
...
def multiplayer_game(playerType):
    global gameOn
    global turn
    ...
    while gameOn:
        ...
        try:
            ...
            multiplayer_game(currentPlayer)
